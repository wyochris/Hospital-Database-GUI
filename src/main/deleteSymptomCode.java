...
//
//public class deleteSymptomCode {
...
//                    } else {
//                        if (returnCode == 1) {
//                            JOptionPane.showMessageDialog(null, "Error: Symptom Name cannot be null");
//                        } else if(returnCode == 2){
//                            JOptionPane.showMessageDialog(null, "Error: Patient ID cannot be null.");
//                        } else if(returnCode == 3) {
//                            JOptionPane.showMessageDialog(null, "Error: Symptom Name does not exist.");
//                        } else if(returnCode == 4) {
//                            JOptionPane.showMessageDialog(null, "Error: Patient does not exist.");
//                        }
//                        else if(returnCode==5){
//                            JOptionPane.showMessageDialog(null, "Error: Patient does not have this symptom.");
//                        }
//
//                        else {
